	...
	public static void main(String[] args) {
		...
		do {
			...
			case 0:
				...
				break;
			case 1: {
				printServices.displayPricesAscendingOrder(priceArray);

			}
				break;
			case 2: {
				printServices.displayPricesDescendingOrder(priceArray);
			...
			case 5: {
				...
				binearySearchImplementation.searchValue(priceArray, stock);
